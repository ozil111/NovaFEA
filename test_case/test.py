...
def main():
    ...
    report_generator = ReportGenerator(runner.results, "test_case/test_report.txt")
    ...
    report_generator1 = ReportGenerator(runner1.results, "test_case/test_benchamrk_report.txt")
